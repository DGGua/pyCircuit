...
def main() -> int:
    ...
    # Current main does not make the partition verifier a global pyc.name
    # namespace gate. Keep this suite focused on stamped/torn partition plans;
    # legacy unstamped naming remains covered by the existing probe pipeline.
    cases = [case for case in cases if "pyc.partition." in case[1]]
